...
type ComplexityRoot struct {
	...
	Query struct {
		Event                func(childComplexity int, eventID int, accountID *int) int
...
type QueryResolver interface {
	...
	Event(ctx context.Context, eventID int, accountID *int) (*model.TimelineEvent, error)
}
...
func (e *executableSchema) Complexity(typeName, field string, childComplexity int, rawArgs map[string]any) (int, bool) {
	...
	case "Query.event":
		...
		return e.complexity.Query.Event(childComplexity, args["eventId"].(int), args["accountId"].(*int)), true
	...
	case "Timeline.accountId":
		if e.complexity.Timeline.AccountID == nil {
			break
		}

		return e.complexity.Timeline.AccountID(childComplexity), true
	...
	case "TimelineEvent.timelineId":
		...
		return e.complexity.TimelineEvent.TimelineID(childComplexity), true
...
func (ec *executionContext) field_Query_event_args(ctx context.Context, rawArgs map[string]any) (map[string]any, error) {
	var err error
	args := map[string]any{}
	arg0, err := ec.field_Query_event_argsEventID(ctx, rawArgs)
	if err != nil {
		return nil, err
	}
	args["eventId"] = arg0
	arg1, err := ec.field_Query_event_argsAccountID(ctx, rawArgs)
	if err != nil {
		return nil, err
	}
	args["accountId"] = arg1
...
func (ec *executionContext) field_Query_event_argsEventID(
	ctx context.Context,
	rawArgs map[string]any,
) (int, error) {
	if _, ok := rawArgs["eventId"]; !ok {
...
func (ec *executionContext) field_Query_event_argsAccountID(
	ctx context.Context,
	rawArgs map[string]any,
) (*int, error) {
	if _, ok := rawArgs["accountId"]; !ok {
...
func (ec *executionContext) _Query_event(ctx context.Context, field graphql.CollectedField) (ret graphql.Marshaler) {
	...
	resTmp, err := ec.ResolverMiddleware(ctx, func(rctx context.Context) (any, error) {
		ctx = rctx // use context from middleware stack in children
		return ec.resolvers.Query().Event(rctx, fc.Args["eventId"].(int), fc.Args["accountId"].(*int))
	})
	if err != nil {
		ec.Error(ctx, err)
		return graphql.Null
	...
	res := resTmp.(*model.TimelineEvent)
	fc.Result = res
	return ec.marshalOTimelineEvent2ᚖtimelineᚋbackendᚋgraphᚋmodelᚐTimelineEvent(ctx, field.Selections, res)
}
...
func (ec *executionContext) _Timeline_accountId(ctx context.Context, field graphql.CollectedField, obj *model.Timeline) (ret graphql.Marshaler) {
	fc, err := ec.fieldContext_Timeline_accountId(ctx, field)
	if err != nil {
		return graphql.Null
	}
	ctx = graphql.WithFieldContext(ctx, fc)
...
func (ec *executionContext) fieldContext_Timeline_accountId(_ context.Context, field graphql.CollectedField) (fc *graphql.FieldContext, err error) {
	fc = &graphql.FieldContext{
		Object:     "Timeline",
		Field:      field,
		IsMethod:   false,
...
func (ec *executionContext) _Timeline_account(ctx context.Context, field graphql.CollectedField, obj *model.Timeline) (ret graphql.Marshaler) {
	...
	resTmp, err := ec.ResolverMiddleware(ctx, func(rctx context.Context) (any, error) {
		ctx = rctx // use context from middleware stack in children
		return ec.resolvers.Timeline().Account(rctx, obj)
	})
	if err != nil {
		ec.Error(ctx, err)
		return graphql.Null
...
func (ec *executionContext) _TimelineEvent_timelineId(ctx context.Context, field graphql.CollectedField, obj *model.TimelineEvent) (ret graphql.Marshaler) {
	fc, err := ec.fieldContext_TimelineEvent_timelineId(ctx, field)
	if err != nil {
		return graphql.Null
	}
	ctx = graphql.WithFieldContext(ctx, fc)
...
func (ec *executionContext) fieldContext_TimelineEvent_timelineId(_ context.Context, field graphql.CollectedField) (fc *graphql.FieldContext, err error) {
	fc = &graphql.FieldContext{
		Object:     "TimelineEvent",
		Field:      field,
		IsMethod:   false,
...
func (ec *executionContext) _Timeline(ctx context.Context, sel ast.SelectionSet, obj *model.Timeline) graphql.Marshaler {
	...
	for i, field := range fields {
		...
		case "accountId":
			out.Values[i] = ec._Timeline_accountId(ctx, field, obj)
			if out.Values[i] == graphql.Null {
				atomic.AddUint32(&out.Invalids, 1)
			}
		case "account":
			...
			innerFunc := func(ctx context.Context, fs *graphql.FieldSet) (res graphql.Marshaler) {
				...
				res = ec._Timeline_account(ctx, field, obj)
				if res == graphql.Null {
					atomic.AddUint32(&fs.Invalids, 1)
				}
				return res
...
func (ec *executionContext) marshalOTimelineEvent2ᚖtimelineᚋbackendᚋgraphᚋmodelᚐTimelineEvent(ctx context.Context, sel ast.SelectionSet, v *model.TimelineEvent) graphql.Marshaler {
	if v == nil {
		return graphql.Null
	}
	return ec._TimelineEvent(ctx, sel, v)
