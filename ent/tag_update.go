...
func (tu *TagUpdate) AddEventIDs(ids ...int) *TagUpdate {
	tu.mutation.AddEventIDs(ids...)
	return tu
}

// AddEvent adds the "event" edges to the Event entity.
func (tu *TagUpdate) AddEvent(e ...*Event) *TagUpdate {
	ids := make([]int, len(e))
	for i := range e {
		ids[i] = e[i].ID
	}
...
func (tu *TagUpdate) sqlSave(ctx context.Context) (n int, err error) {
	...
	if tu.mutation.EventCleared() {
		edge := &sqlgraph.EdgeSpec{
			Rel:     sqlgraph.M2M,
			Inverse: false,
			Table:   tag.EventTable,
			Columns: tag.EventPrimaryKey,
			Bidi:    false,
...
// AddEventIDs adds the "event" edge to the Event entity by IDs.
func (tuo *TagUpdateOne) AddEventIDs(ids ...int) *TagUpdateOne {
	tuo.mutation.AddEventIDs(ids...)
	return tuo
}

// AddEvent adds the "event" edges to the Event entity.
func (tuo *TagUpdateOne) AddEvent(e ...*Event) *TagUpdateOne {
	ids := make([]int, len(e))
	for i := range e {
		ids[i] = e[i].ID
	}
...
// ClearEvent clears all "event" edges to the Event entity.
func (tuo *TagUpdateOne) ClearEvent() *TagUpdateOne {
	tuo.mutation.ClearEvent()
	return tuo
}

// RemoveEventIDs removes the "event" edge to Event entities by IDs.
func (tuo *TagUpdateOne) RemoveEventIDs(ids ...int) *TagUpdateOne {
	tuo.mutation.RemoveEventIDs(ids...)
	return tuo
}

// RemoveEvent removes "event" edges to Event entities.
func (tuo *TagUpdateOne) RemoveEvent(e ...*Event) *TagUpdateOne {
	ids := make([]int, len(e))
	for i := range e {
		ids[i] = e[i].ID
	}
