...
func (e TagEdges) EventOrErr() ([]*Event, error) {
	if e.loadedTypes[0] {
		return e.Event, nil
	}
...
// QueryEvent queries the "event" edge of the Tag entity.
func (t *Tag) QueryEvent() *EventQuery {
	return NewTagClient(t.config).QueryEvent(t)
}
