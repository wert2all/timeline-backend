...
func (c *Client) Use(hooks ...Hook) {
	for _, n := range []interface{ Use(...Hook) }{
		c.Account, c.Event, c.Settings, c.Tag, c.Timeline, c.User,
	} {
		n.Use(hooks...)
	}
}
...
type (
	hooks struct {
		Account, Event, Settings, Tag, Timeline, User []ent.Hook
	}
	inters struct {
		Account, Event, Settings, Tag, Timeline, User []ent.Interceptor
	}
)
